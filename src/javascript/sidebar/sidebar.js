...
export function sidebar(){
    ...
    const sideMenu = {
        ...
        createMenu: function(){
            ...
            createMenu.setAttribute("class", "side-bar border-end border-4 border-info h-100 w-100 d-flex flex-column justify-content-start align-items-center bg-secondary text-black pt-5");
